...
export default function SearchBar({ item }) {
  return (
    <div className="flex w-full flex-row gap-3 px-8 md:gap-6 md:px-16">
      ...
      />
      <div className="aspect-square h-8 rounded-full bg-[#E9B472] hover:bg-[#C6975D] md:h-10">
        <Image
      ...
      <div className="aspect-square h-8 rounded-full bg-[#092928] hover:bg-black md:h-10">
        <Image
